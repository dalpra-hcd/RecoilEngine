...
decltype(VA_TYPE_TC::attributeDefs) VA_TYPE_TC::attributeDefs = {
...
decltype(VA_TYPE_TC3::attributeDefs) VA_TYPE_TC3::attributeDefs = {
...
decltype(VA_TYPE_PROJ::attributeDefs) VA_TYPE_PROJ::attributeDefs = {
...
decltype(VA_TYPE_2DTC3::attributeDefs) VA_TYPE_2DTC3::attributeDefs = {
